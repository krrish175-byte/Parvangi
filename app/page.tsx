                ...
                <div style={{ maxWidth: '1020px', margin: '0 auto' }}>
                  <div style={{ textAlign: 'center', marginBottom: '28px' }}>
                    ...
                    <p style={{ fontSize: '13.5px', color: 'var(--gov-text-secondary)', maxWidth: '780px', margin: '8px auto 0 auto', lineHeight: 1.6 }}>
                      {language === 'mr'
                        ? 'परवानगी प्रणाली हे खालील अधिकृत संसदीय व राज्य कायदे आणि नियमावलीनुसार पूर्वअटींचा काटेकोर क्रम निश्चित करते.'
                        : language === 'hi'
                  ...
                  <div className="gov-framework-grid">
                    <div className="gov-framework-card" style={{ borderTop: '4px solid #d97706' }}>
                      <div className="gov-framework-header">
                        <span className="gov-framework-icon">
                  ...
                  <div className="gov-launch-banner">
                    <div>
                      ...
                      <div style={{ fontSize: '12px', color: 'var(--gov-text-muted)' }}>
                        {language === 'mr'
                          ? 'विनामूल्य, निःपक्ष व संपूर्ण पारदर्शक नियामक पडताळणी.'
                          : language === 'hi'
                          ? 'निःशुल्क, निष्पक्ष एवं पारदर्शी विनियामक सत्यापन।'
                          : 'Open public service · Instant statutory clearance certificate generation.'}
                      </div>
                    </div>
